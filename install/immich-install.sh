...
$STD apt install --no-install-recommends -yqq \
  autoconf automake libtool libtool-bin libltdl-dev build-essential cmake jq libbrotli-dev libde265-dev libexif-dev \
